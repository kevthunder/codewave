...
(function() {
  ...
  this.Codewave.Command.loadCmds = function() {
    var data, fullname, savedCmds, _i, _len, _results;
    savedCmds = Codewave.storage.load('cmds');
    if (savedCmds != null) {
      _results = [];
      for (data = _i = 0, _len = savedCmds.length; _i < _len; data = ++_i) {
        fullname = savedCmds[data];
        _results.push(Codewave.Command.cmds.setCmd(fullname, Command(fullname.split(':').pop(), data)));
      }
      return _results;
    }
  };
