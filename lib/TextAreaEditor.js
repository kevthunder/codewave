...
export var DomKeyListener = class DomKeyListener {
...
export var TextAreaEditor = (function() {
  class TextAreaEditor extends TextParser {
    constructor(target1) {
      super();
      this.target = target1;
    ...
    spliceText(start, end, text) {
      return this.textEventChange(text, start, end) || super.spliceText(start, end, text);
    }
...
//# sourceMappingURL=maps/TextAreaEditor.js.map
