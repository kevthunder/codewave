...
const ParamParser = require("./stringParsers/ParamParser");

const Pos = require("./positioning/Pos");

const StrPos = require("./positioning/StrPos");
...
var PositionedCmdInstance = class PositionedCmdInstance extends CmdInstance.CmdInstance {
  ...
  alterAliasOf(aliasOf) {
    var cmdName, nspc;
    [nspc, cmdName] = NamespaceHelper.NamespaceHelper.split(this.cmdName);
