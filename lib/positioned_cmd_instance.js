...
this.Codewave.PositionedCmdInstance = class PositionedCmdInstance extends this.Codewave.CmdInstance {
  ...
  alterAliasOf(aliasOf) {
    var cmdName, nspc;
    [nspc, cmdName] = Codewave.util.splitNamespace(this.cmdName);
...
//# sourceMappingURL=maps/positioned_cmd_instance.js.map
