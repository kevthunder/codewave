...
var BoxCmd, CloseCmd, EditCmd, EmmetCmd, NameSpaceCmd, aliasCommand, exec_parent, getContent, getParam, initCmds, no_execute, quote_carret, removeCommand, renameCommand;
...
BoxCmd = class BoxCmd extends Codewave.BaseCommand {
  init() {
...
CloseCmd = class CloseCmd extends Codewave.BaseCommand {
  init() {
...
EditCmd = class EditCmd extends Codewave.BaseCommand {
  init() {
    var ref;
...
NameSpaceCmd = class NameSpaceCmd extends Codewave.BaseCommand {
  init() {
...
EmmetCmd = class EmmetCmd extends this.Codewave.BaseCommand {
  init() {
